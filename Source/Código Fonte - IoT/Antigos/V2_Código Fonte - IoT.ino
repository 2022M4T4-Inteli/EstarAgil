...
bool getFtmReport(){
  ...
  return xSemaphoreTake(ftmSemaphore, portMAX_DELAY) == pdPASS && ftmSuccess; //Em caso de sucesso irá aguardar o sinal de que o relatório foi recebido e retornar o verdadeiro.
}
